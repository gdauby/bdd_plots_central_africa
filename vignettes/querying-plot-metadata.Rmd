...
mydb <- call.mydb(using_credentials = TRUE)
mydb.taxa <- call.mydb.taxa(using_credentials = TRUE)
```
...
**Important**: The connection functions will prompt for credentials interactively. Never hard-code credentials in your scripts or vignettes.
...
This returns a data frame containing plot-level information such as:
